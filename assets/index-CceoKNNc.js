 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,$){var j=D.length;D.push($);e:for(;0<j;){var ie=j-1>>>1,de=D[ie];if(0<r(de,$))D[ie]=$,D[j]=de,j=ie;else break e}}function n(D){return D.length===0?null:D[0]}function i(D){if(D.length===0)return null;var $=D[0],j=D.pop();if(j!==$){D[0]=j;e:for(var ie=0,de=D.length,Se=de>>>1;ie<Se;){var V=2*(ie+1)-1,Q=D[V],ue=V+1,Z=D[ue];if(0>r(Q,j))ue<de&&0>r(Z,Q)?(D[ie]=Z,D[ue]=j,ie=ue):(D[ie]=Q,D[V]=j,ie=V);else if(ue<de&&0>r(Z,j))D[ie]=Z,D[ue]=j,ie=ue;else break e}}return $}function r(D,$){var j=D.sortIndex-$.sortIndex;return j!==0?j:D.id-$.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],f=1,h=null,d=3,p=!1,v=!1,x=!1,m=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(D){for(var $=n(u);$!==null;){if($.callback===null)i(u);else if($.startTime<=D)i(u),$.sortIndex=$.expirationTime,e(l,$);else break;$=n(u)}}function M(D){if(x=!1,g(D),!v)if(n(l)!==null)v=!0,G(L);else{var $=n(u);$!==null&&Y(M,$.startTime-D)}}function L(D,$){v=!1,x&&(x=!1,c(C),C=-1),p=!0;var j=d;try{for(g($),h=n(l);h!==null&&(!(h.expirationTime>$)||D&&!P());){var ie=h.callback;if(typeof ie=="function"){h.callback=null,d=h.priorityLevel;var de=ie(h.expirationTime<=$);$=t.unstable_now(),typeof de=="function"?h.callback=de:h===n(l)&&i(l),g($)}else i(l);h=n(l)}if(h!==null)var Se=!0;else{var V=n(u);V!==null&&Y(M,V.startTime-$),Se=!1}return Se}finally{h=null,d=j,p=!1}}var A=!1,w=null,C=-1,T=5,y=-1;function P(){return!(t.unstable_now()-y<T)}function k(){if(w!==null){var D=t.unstable_now();y=D;var $=!0;try{$=w(!0,D)}finally{$?O():(A=!1,w=null)}}else A=!1}var O;if(typeof _=="function")O=function(){_(k)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,W=X.port2;X.port1.onmessage=k,O=function(){W.postMessage(null)}}else O=function(){m(k,0)};function G(D){w=D,A||(A=!0,O())}function Y(D,$){C=m(function(){D(t.unstable_now())},$)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){v||p||(v=!0,G(L))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(D){switch(d){case 1:case 2:case 3:var $=3;break;default:$=d}var j=d;d=$;try{return D()}finally{d=j}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,$){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var j=d;d=D;try{return $()}finally{d=j}},t.unstable_scheduleCallback=function(D,$,j){var ie=t.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?ie+j:ie):j=ie,D){case 1:var de=-1;break;case 2:de=250;break;case 5:de=1073741823;break;case 4:de=1e4;break;default:de=5e3}return de=j+de,D={id:f++,callback:$,priorityLevel:D,startTime:j,expirationTime:de,sortIndex:-1},j>ie?(D.sortIndex=j,e(u,D),n(l)===null&&D===n(u)&&(x?(c(C),C=-1):x=!0,Y(M,j-ie))):(D.sortIndex=de,e(l,D),v||p||(v=!0,G(L))),D},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(D){var $=d;return function(){var j=d;d=$;try{return D.apply(this,arguments)}finally{d=j}}}})(Dm);Lm.exports=Dm;var Fv=Lm.exports;/**
 * @license React
...
`)+`
`+c);const g=_+m+o,M=_+c+a,L=Kp(r,r.VERTEX_SHADER,g),A=Kp(r,r.FRAGMENT_SHADER,M);r.attachShader(x,L),r.attachShader(x,A),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function w(P){if(t.debug.checkShaderErrors){const k=r.getProgramInfoLog(x).trim(),O=r.getShaderInfoLog(L).trim(),X=r.getShaderInfoLog(A).trim();let W=!0,G=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(W=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,L,A);else{const Y=Zp(r,L,"vertex"),D=Zp(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
}`;function qT(t,e,n){let i=new tv;const r=new He,s=new He,o=new lt,a=new XT({depthPacking:Ay}),l=new $T,u={},f=n.maxTextureSize,h={[er]:sn,[sn]:er,[di]:di},d=new Ti({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new He},radius:{value:4}},vertexShader:YT,fragmentShader:jT}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const v=new Rn;v.setAttribute("position",new Gn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new kn(v,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=D_;let c=this.type;this.render=function(A,w,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;const T=t.getRenderTarget(),y=t.getActiveCubeFace(),P=t.getActiveMipmapLevel(),k=t.state;k.setBlending(Ki),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const O=c!==ui&&this.type===ui,X=c===ui&&this.type!==ui;for(let W=0,G=A.length;W<G;W++){const Y=A[W],D=Y.shadow;if(D===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(D.autoUpdate===!1&&D.needsUpdate===!1)continue;r.copy(D.mapSize);const $=D.getFrameExtents();if(r.multiply($),s.copy(D.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/$.x),r.x=s.x*$.x,D.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/$.y),r.y=s.y*$.y,D.mapSize.y=s.y)),D.map===null||O===!0||X===!0){const ie=this.type!==ui?{minFilter:Tn,magFilter:Tn}:{};D.map!==null&&D.map.dispose(),D.map=new Ir(r.x,r.y,ie),D.map.texture.name=Y.name+".shadowMap",D.camera.updateProjectionMatrix()}t.setRenderTarget(D.map),t.clear();const j=D.getViewportCount();for(let ie=0;ie<j;ie++){const de=D.getViewport(ie);o.set(s.x*de.x,s.y*de.y,s.x*de.z,s.y*de.w),k.viewport(o),D.updateMatrices(Y,ie),i=D.getFrustum(),M(w,C,D.camera,Y,this.type)}D.isPointLightShadow!==!0&&this.type===ui&&_(D,C),D.needsUpdate=!1}c=this.type,m.needsUpdate=!1,t.setRenderTarget(T,y,P)};function _(A,w){const C=e.update(x);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Ir(r.x,r.y)),d.uniforms.shadow_pass.value=A.map.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,t.setRenderTarget(A.mapPass),t.clear(),t.renderBufferDirect(w,null,C,d,x,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,t.setRenderTarget(A.map),t.clear(),t.renderBufferDirect(w,null,C,p,x,null)}function g(A,w,C,T){let y=null;const P=C.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(P!==void 0)y=P;else if(y=C.isPointLight===!0?l:a,t.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const k=y.uuid,O=w.uuid;let X=u[k];X===void 0&&(X={},u[k]=X);let W=X[O];W===void 0&&(W=y.clone(),X[O]=W,w.addEventListener("dispose",L)),y=W}if(y.visible=w.visible,y.wireframe=w.wireframe,T===ui?y.side=w.shadowSide!==null?w.shadowSide:w.side:y.side=w.shadowSide!==null?w.shadowSide:h[w.side],y.alphaMap=w.alphaMap,y.alphaTest=w.alphaTest,y.map=w.map,y.clipShadows=w.clipShadows,y.clippingPlanes=w.clippingPlanes,y.clipIntersection=w.clipIntersection,y.displacementMap=w.displacementMap,y.displacementScale=w.displacementScale,y.displacementBias=w.displacementBias,y.wireframeLinewidth=w.wireframeLinewidth,y.linewidth=w.linewidth,C.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const k=t.properties.get(y);k.light=C}return y}function M(A,w,C,T,y){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&y===ui)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,A.matrixWorld);const O=e.update(A),X=A.material;if(Array.isArray(X)){const W=O.groups;for(let G=0,Y=W.length;G<Y;G++){const D=W[G],$=X[D.materialIndex];if($&&$.visible){const j=g(A,$,T,y);A.onBeforeShadow(t,A,w,C,O,j,D),t.renderBufferDirect(C,null,O,j,A,D),A.onAfterShadow(t,A,w,C,O,j,D)}}}else if(X.visible){const W=g(A,X,T,y);A.onBeforeShadow(t,A,w,C,O,W,null),t.renderBufferDirect(C,null,O,W,A,null),A.onAfterShadow(t,A,w,C,O,W,null)}}const k=A.children;for(let O=0,X=k.length;O<X;O++)M(k[O],w,C,T,y)}function L(A){A.target.removeEventListener("dispose",L);for(const C in u){const T=u[C],y=A.target.uuid;y in T&&(T[y].dispose(),delete T[y])}}}function KT(t){function e(){let I=!1;const se=new lt;let q=null;const K=new lt(0,0,0,0);return{setMask:function(ae){q!==ae&&!I&&(t.colorMask(ae,ae,ae,ae),q=ae)},setLocked:function(ae){I=ae},setClear:function(ae,we,Ve,vt,bt){bt===!0&&(ae*=vt,we*=vt,Ve*=vt),se.set(ae,we,Ve,vt),K.equals(se)===!1&&(t.clearColor(ae,we,Ve,vt),K.copy(se))},reset:function(){I=!1,q=null,K.set(-1,0,0,0)}}}function n(){let I=!1,se=null,q=null,K=null;return{setTest:function(ae){ae?ue(t.DEPTH_TEST):Z(t.DEPTH_TEST)},setMask:function(ae){se!==ae&&!I&&(t.depthMask(ae),se=ae)},setFunc:function(ae){if(q!==ae){switch(ae){case ly:t.depthFunc(t.NEVER);break;case uy:t.depthFunc(t.ALWAYS);break;case cy:t.depthFunc(t.LESS);break;case Pl:t.depthFunc(t.LEQUAL);break;case fy:t.depthFunc(t.EQUAL);break;case dy:t.depthFunc(t.GEQUAL);break;case hy:t.depthFunc(t.GREATER);break;case py:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}q=ae}},setLocked:function(ae){I=ae},setClear:function(ae){K!==ae&&(t.clearDepth(ae),K=ae)},reset:function(){I=!1,se=null,q=null,K=null}}}function i(){let I=!1,se=null,q=null,K=null,ae=null,we=null,Ve=null,vt=null,bt=null;return{setTest:function(We){I||(We?ue(t.STENCIL_TEST):Z(t.STENCIL_TEST))},setMask:function(We){se!==We&&!I&&(t.stencilMask(We),se=We)},setFunc:function(We,ii,Xn){(q!==We||K!==ii||ae!==Xn)&&(t.stencilFunc(We,ii,Xn),q=We,K=ii,ae=Xn)},setOp:function(We,ii,Xn){(we!==We||Ve!==ii||vt!==Xn)&&(t.stencilOp(We,ii,Xn),we=We,Ve=ii,vt=Xn)},setLocked:function(We){I=We},setClear:function(We){bt!==We&&(t.clearStencil(We),bt=We)},reset:function(){I=!1,se=null,q=null,K=null,ae=null,we=null,Ve=null,vt=null,bt=null}}}const r=new e,s=new n,o=new i,a=new WeakMap,l=new WeakMap;let u={},f={},h=new WeakMap,d=[],p=null,v=!1,x=null,m=null,c=null,_=null,g=null,M=null,L=null,A=new qe(0,0,0),w=0,C=!1,T=null,y=null,P=null,k=null,O=null;const X=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,G=0;const Y=t.getParameter(t.VERSION);Y.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(Y)[1]),W=G>=1):Y.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),W=G>=2);let D=null,$={};const j=t.getParameter(t.SCISSOR_BOX),ie=t.getParameter(t.VIEWPORT),de=new lt().fromArray(j),Se=new lt().fromArray(ie);function V(I,se,q,K){const ae=new Uint8Array(4),we=t.createTexture();t.bindTexture(I,we),t.texParameteri(I,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(I,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ve=0;Ve<q;Ve++)I===t.TEXTURE_3D||I===t.TEXTURE_2D_ARRAY?t.texImage3D(se,0,t.RGBA,1,1,K,0,t.RGBA,t.UNSIGNED_BYTE,ae):t.texImage2D(se+Ve,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ae);return we}const Q={};Q[t.TEXTURE_2D]=V(t.TEXTURE_2D,t.TEXTURE_2D,1),Q[t.TEXTURE_CUBE_MAP]=V(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[t.TEXTURE_2D_ARRAY]=V(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),Q[t.TEXTURE_3D]=V(t.TEXTURE_3D,t.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),ue(t.DEPTH_TEST),s.setFunc(Pl),Je(!1),Me(cp),ue(t.CULL_FACE),gt(Ki);function ue(I){u[I]!==!0&&(t.enable(I),u[I]=!0)}function Z(I){u[I]!==!1&&(t.disable(I),u[I]=!1)}function xe(I,se){return f[I]!==se?(t.bindFramebuffer(I,se),f[I]=se,I===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=se),I===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=se),!0):!1}function Pe(I,se){let q=d,K=!1;if(I){q=h.get(se),q===void 0&&(q=[],h.set(se,q));const ae=I.textures;if(q.length!==ae.length||q[0]!==t.COLOR_ATTACHMENT0){for(let we=0,Ve=ae.length;we<Ve;we++)q[we]=t.COLOR_ATTACHMENT0+we;q.length=ae.length,K=!0}}else q[0]!==t.BACK&&(q[0]=t.BACK,K=!0);K&&t.drawBuffers(q)}function be(I){return p!==I?(t.useProgram(I),p=I,!0):!1}const tt={[_r]:t.FUNC_ADD,[Xx]:t.FUNC_SUBTRACT,[$x]:t.FUNC_REVERSE_SUBTRACT};tt[Yx]=t.MIN,tt[jx]=t.MAX;const b={[qx]:t.ZERO,[Kx]:t.ONE,[Zx]:t.SRC_COLOR,[tf]:t.SRC_ALPHA,[iy]:t.SRC_ALPHA_SATURATE,[ty]:t.DST_COLOR,[Jx]:t.DST_ALPHA,[Qx]:t.ONE_MINUS_SRC_COLOR,[nf]:t.ONE_MINUS_SRC_ALPHA,[ny]:t.ONE_MINUS_DST_COLOR,[ey]:t.ONE_MINUS_DST_ALPHA,[ry]:t.CONSTANT_COLOR,[sy]:t.ONE_MINUS_CONSTANT_COLOR,[oy]:t.CONSTANT_ALPHA,[ay]:t.ONE_MINUS_CONSTANT_ALPHA};function gt(I,se,q,K,ae,we,Ve,vt,bt,We){if(I===Ki){v===!0&&(Z(t.BLEND),v=!1);return}if(v===!1&&(ue(t.BLEND),v=!0),I!==Wx){if(I!==x||We!==C){if((m!==_r||g!==_r)&&(t.blendEquation(t.FUNC_ADD),m=_r,g=_r),We)switch(I){case ys:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case fp:t.blendFunc(t.ONE,t.ONE);break;case dp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case hp:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}else switch(I){case ys:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case fp:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case dp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case hp:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}c=null,_=null,M=null,L=null,A.set(0,0,0),w=0,x=I,C=We}return}ae=ae||se,we=we||q,Ve=Ve||K,(se!==m||ae!==g)&&(t.blendEquationSeparate(tt[se],tt[ae]),m=se,g=ae),(q!==c||K!==_||we!==M||Ve!==L)&&(t.blendFuncSeparate(b[q],b[K],b[we],b[Ve]),c=q,_=K,M=we,L=Ve),(vt.equals(A)===!1||bt!==w)&&(t.blendColor(vt.r,vt.g,vt.b,bt),A.copy(vt),w=bt),x=I,C=!1}function Ke(I,se){I.side===di?Z(t.CULL_FACE):ue(t.CULL_FACE);let q=I.side===sn;se&&(q=!q),Je(q),I.blending===ys&&I.transparent===!1?gt(Ki):gt(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),s.setFunc(I.depthFunc),s.setTest(I.depthTest),s.setMask(I.depthWrite),r.setMask(I.colorWrite);const K=I.stencilWrite;o.setTest(K),K&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Le(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?ue(t.SAMPLE_ALPHA_TO_COVERAGE):Z(t.SAMPLE_ALPHA_TO_COVERAGE)}function Je(I){T!==I&&(I?t.frontFace(t.CW):t.frontFace(t.CCW),T=I)}function Me(I){I!==Hx?(ue(t.CULL_FACE),I!==y&&(I===cp?t.cullFace(t.BACK):I===Vx?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Z(t.CULL_FACE),y=I}function _t(I){I!==P&&(W&&t.lineWidth(I),P=I)}function Le(I,se,q){I?(ue(t.POLYGON_OFFSET_FILL),(k!==se||O!==q)&&(t.polygonOffset(se,q),k=se,O=q)):Z(t.POLYGON_OFFSET_FILL)}function Ie(I){I?ue(t.SCISSOR_TEST):Z(t.SCISSOR_TEST)}function R(I){I===void 0&&(I=t.TEXTURE0+X-1),D!==I&&(t.activeTexture(I),D=I)}function S(I,se,q){q===void 0&&(D===null?q=t.TEXTURE0+X-1:q=D);let K=$[q];K===void 0&&(K={type:void 0,texture:void 0},$[q]=K),(K.type!==I||K.texture!==se)&&(D!==q&&(t.activeTexture(q),D=q),t.bindTexture(I,se||Q[I]),K.type=I,K.texture=se)}function H(){const I=$[D];I!==void 0&&I.type!==void 0&&(t.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function ee(){try{t.compressedTexImage2D.apply(t,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ne(){try{t.compressedTexImage3D.apply(t,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function J(){try{t.texSubImage2D.apply(t,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ee(){try{t.texSubImage3D.apply(t,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ce(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function me(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ue(){try{t.texStorage2D.apply(t,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function re(){try{t.texStorage3D.apply(t,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function pe(){try{t.texImage2D.apply(t,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ke(){try{t.texImage3D.apply(t,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Re(I){de.equals(I)===!1&&(t.scissor(I.x,I.y,I.z,I.w),de.copy(I))}function ge(I){Se.equals(I)===!1&&(t.viewport(I.x,I.y,I.z,I.w),Se.copy(I))}function De(I,se){let q=l.get(se);q===void 0&&(q=new WeakMap,l.set(se,q));let K=q.get(I);K===void 0&&(K=t.getUniformBlockIndex(se,I.name),q.set(I,K))}function Oe(I,se){const K=l.get(se).get(I);a.get(se)!==K&&(t.uniformBlockBinding(se,K,I.__bindingPointIndex),a.set(se,K))}function ot(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),u={},D=null,$={},f={},h=new WeakMap,d=[],p=null,v=!1,x=null,m=null,c=null,_=null,g=null,M=null,L=null,A=new qe(0,0,0),w=0,C=!1,T=null,y=null,P=null,k=null,O=null,de.set(0,0,t.canvas.width,t.canvas.height),Se.set(0,0,t.canvas.width,t.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:ue,disable:Z,bindFramebuffer:xe,drawBuffers:Pe,useProgram:be,setBlending:gt,setMaterial:Ke,setFlipSided:Je,setCullFace:Me,setLineWidth:_t,setPolygonOffset:Le,setScissorTest:Ie,activeTexture:R,bindTexture:S,unbindTexture:H,compressedTexImage2D:ee,compressedTexImage3D:ne,texImage2D:pe,texImage3D:ke,updateUBOMapping:De,uniformBlockBinding:Oe,texStorage2D:Ue,texStorage3D:re,texSubImage2D:J,texSubImage3D:Ee,compressedTexSubImage2D:ce,compressedTexSubImage3D:me,scissor:Re,viewport:ge,reset:ot}}function sm(t,e,n,i){const r=ZT(i);switch(n){case z_:return t*e;case k_:return t*e;case H_:return t*e*2;case V_:return t*e/r.components*r.byteLength;case Fd:return t*e/r.components*r.byteLength;case G_:return t*e*2/r.components*r.byteLength;case Od:return t*e*2/r.components*r.byteLength;case B_:return t*e*3/r.components*r.byteLength;case Bn:return t*e*4/r.components*r.byteLength;case zd:return t*e*4/r.components*r.byteLength;case Ja:case el:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case tl:case nl:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case uf:case ff:return Math.max(t,16)*Math.max(e,8)/4;case lf:case cf:return Math.max(t,8)*Math.max(e,8)/2;case df:case hf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case pf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case mf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case gf:return Math.floor((t+4)/5)*Math.floor((e+3)/4)*16;case _f:return Math.floor((t+4)/5)*Math.floor((e+4)/5)*16;case vf:return Math.floor((t+5)/6)*Math.floor((e+4)/5)*16;case xf:return Math.floor((t+5)/6)*Math.floor((e+5)/6)*16;case yf:return Math.floor((t+7)/8)*Math.floor((e+4)/5)*16;case Sf:return Math.floor((t+7)/8)*Math.floor((e+5)/6)*16;case Mf:return Math.floor((t+7)/8)*Math.floor((e+7)/8)*16;case Ef:return Math.floor((t+9)/10)*Math.floor((e+4)/5)*16;case Tf:return Math.floor((t+9)/10)*Math.floor((e+5)/6)*16;case wf:return Math.floor((t+9)/10)*Math.floor((e+7)/8)*16;case Af:return Math.floor((t+9)/10)*Math.floor((e+9)/10)*16;case Cf:return Math.floor((t+11)/12)*Math.floor((e+9)/10)*16;case Rf:return Math.floor((t+11)/12)*Math.floor((e+11)/12)*16;case il:case Pf:case bf:return Math.ceil(t/4)*Math.ceil(e/4)*16;case W_:case Lf:return Math.ceil(t/4)*Math.ceil(e/4)*8;case Df:case If:return Math.ceil(t/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function ZT(t){switch(t){case Ei:case N_:return{byteLength:1,components:1};case Fo:case F_:case Go:return{byteLength:2,components:1};case Ud:case Nd:return{byteLength:2,components:4};case Dr:case Id:case mi:return{byteLength:4,components:1};case O_:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${t}.`)}function QT(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new He,f=new WeakMap;let h;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(R,S){return p?new OffscreenCanvas(R,S):Ul("canvas")}function x(R,S,H){let ee=1;const ne=Ie(R);if((ne.width>H||ne.height>H)&&(ee=H/Math.max(ne.width,ne.height)),ee<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const J=Math.floor(ee*ne.width),Ee=Math.floor(ee*ne.height);h===void 0&&(h=v(J,Ee));const ce=S?v(J,Ee):h;return ce.width=J,ce.height=Ee,ce.getContext("2d").drawImage(R,0,0,J,Ee),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+J+"x"+Ee+")."),ce}else return"data"in R&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),R;return R}function m(R){return R.generateMipmaps&&R.minFilter!==Tn&&R.minFilter!==On}function c(R){t.generateMipmap(R)}function _(R,S,H,ee,ne=!1){if(R!==null){if(t[R]!==void 0)return t[R];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let J=S;if(S===t.RED&&(H===t.FLOAT&&(J=t.R32F),H===t.HALF_FLOAT&&(J=t.R16F),H===t.UNSIGNED_BYTE&&(J=t.R8)),S===t.RED_INTEGER&&(H===t.UNSIGNED_BYTE&&(J=t.R8UI),H===t.UNSIGNED_SHORT&&(J=t.R16UI),H===t.UNSIGNED_INT&&(J=t.R32UI),H===t.BYTE&&(J=t.R8I),H===t.SHORT&&(J=t.R16I),H===t.INT&&(J=t.R32I)),S===t.RG&&(H===t.FLOAT&&(J=t.RG32F),H===t.HALF_FLOAT&&(J=t.RG16F),H===t.UNSIGNED_BYTE&&(J=t.RG8)),S===t.RG_INTEGER&&(H===t.UNSIGNED_BYTE&&(J=t.RG8UI),H===t.UNSIGNED_SHORT&&(J=t.RG16UI),H===t.UNSIGNED_INT&&(J=t.RG32UI),H===t.BYTE&&(J=t.RG8I),H===t.SHORT&&(J=t.RG16I),H===t.INT&&(J=t.RG32I)),S===t.RGB&&H===t.UNSIGNED_INT_5_9_9_9_REV&&(J=t.RGB9_E5),S===t.RGBA){const Ee=ne?bl:je.getTransfer(ee);H===t.FLOAT&&(J=t.RGBA32F),H===t.HALF_FLOAT&&(J=t.RGBA16F),H===t.UNSIGNED_BYTE&&(J=Ee===it?t.SRGB8_ALPHA8:t.RGBA8),H===t.UNSIGNED_SHORT_4_4_4_4&&(J=t.RGBA4),H===t.UNSIGNED_SHORT_5_5_5_1&&(J=t.RGB5_A1)}return(J===t.R16F||J===t.R32F||J===t.RG16F||J===t.RG32F||J===t.RGBA16F||J===t.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function g(R,S){let H;return R?S===null||S===Dr||S===Is?H=t.DEPTH24_STENCIL8:S===mi?H=t.DEPTH32F_STENCIL8:S===Fo&&(H=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===Dr||S===Is?H=t.DEPTH_COMPONENT24:S===mi?H=t.DEPTH_COMPONENT32F:S===Fo&&(H=t.DEPTH_COMPONENT16),H}function M(R,S){return m(R)===!0||R.isFramebufferTexture&&R.minFilter!==Tn&&R.minFilter!==On?Math.log2(Math.max(S.width,S.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?S.mipmaps.length:1}function L(R){const S=R.target;S.removeEventListener("dispose",L),w(S),S.isVideoTexture&&f.delete(S)}function A(R){const S=R.target;S.removeEventListener("dispose",A),T(S)}function w(R){const S=i.get(R);if(S.__webglInit===void 0)return;const H=R.source,ee=d.get(H);if(ee){const ne=ee[S.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&C(R),Object.keys(ee).length===0&&d.delete(H)}i.remove(R)}function C(R){const S=i.get(R);t.deleteTexture(S.__webglTexture);const H=R.source,ee=d.get(H);delete ee[S.__cacheKey],o.memory.textures--}function T(R){const S=i.get(R);if(R.depthTexture&&R.depthTexture.dispose(),R.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(S.__webglFramebuffer[ee]))for(let ne=0;ne<S.__webglFramebuffer[ee].length;ne++)t.deleteFramebuffer(S.__webglFramebuffer[ee][ne]);else t.deleteFramebuffer(S.__webglFramebuffer[ee]);S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer[ee])}else{if(Array.isArray(S.__webglFramebuffer))for(let ee=0;ee<S.__webglFramebuffer.length;ee++)t.deleteFramebuffer(S.__webglFramebuffer[ee]);else t.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&t.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let ee=0;ee<S.__webglColorRenderbuffer.length;ee++)S.__webglColorRenderbuffer[ee]&&t.deleteRenderbuffer(S.__webglColorRenderbuffer[ee]);S.__webglDepthRenderbuffer&&t.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const H=R.textures;for(let ee=0,ne=H.length;ee<ne;ee++){const J=i.get(H[ee]);J.__webglTexture&&(t.deleteTexture(J.__webglTexture),o.memory.textures--),i.remove(H[ee])}i.remove(R)}let y=0;function P(){y=0}function k(){const R=y;return R>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+r.maxTextures),y+=1,R}function O(R){const S=[];return S.push(R.wrapS),S.push(R.wrapT),S.push(R.wrapR||0),S.push(R.magFilter),S.push(R.minFilter),S.push(R.anisotropy),S.push(R.internalFormat),S.push(R.format),S.push(R.type),S.push(R.generateMipmaps),S.push(R.premultiplyAlpha),S.push(R.flipY),S.push(R.unpackAlignment),S.push(R.colorSpace),S.join()}function X(R,S){const H=i.get(R);if(R.isVideoTexture&&_t(R),R.isRenderTargetTexture===!1&&R.version>0&&H.__version!==R.version){const ee=R.image;if(ee===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Se(H,R,S);return}}n.bindTexture(t.TEXTURE_2D,H.__webglTexture,t.TEXTURE0+S)}function W(R,S){const H=i.get(R);if(R.version>0&&H.__version!==R.version){Se(H,R,S);return}n.bindTexture(t.TEXTURE_2D_ARRAY,H.__webglTexture,t.TEXTURE0+S)}function G(R,S){const H=i.get(R);if(R.version>0&&H.__version!==R.version){Se(H,R,S);return}n.bindTexture(t.TEXTURE_3D,H.__webglTexture,t.TEXTURE0+S)}function Y(R,S){const H=i.get(R);if(R.version>0&&H.__version!==R.version){V(H,R,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,H.__webglTexture,t.TEXTURE0+S)}const D={[of]:t.REPEAT,[Mr]:t.CLAMP_TO_EDGE,[af]:t.MIRRORED_REPEAT},$={[Tn]:t.NEAREST,[Ty]:t.NEAREST_MIPMAP_NEAREST,[da]:t.NEAREST_MIPMAP_LINEAR,[On]:t.LINEAR,[Iu]:t.LINEAR_MIPMAP_NEAREST,[Er]:t.LINEAR_MIPMAP_LINEAR},j={[Py]:t.NEVER,[Ny]:t.ALWAYS,[by]:t.LESS,[X_]:t.LEQUAL,[Ly]:t.EQUAL,[Uy]:t.GEQUAL,[Dy]:t.GREATER,[Iy]:t.NOTEQUAL};function ie(R,S){if(S.type===mi&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===On||S.magFilter===Iu||S.magFilter===da||S.magFilter===Er||S.minFilter===On||S.minFilter===Iu||S.minFilter===da||S.minFilter===Er)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(R,t.TEXTURE_WRAP_S,D[S.wrapS]),t.texParameteri(R,t.TEXTURE_WRAP_T,D[S.wrapT]),(R===t.TEXTURE_3D||R===t.TEXTURE_2D_ARRAY)&&t.texParameteri(R,t.TEXTURE_WRAP_R,D[S.wrapR]),t.texParameteri(R,t.TEXTURE_MAG_FILTER,$[S.magFilter]),t.texParameteri(R,t.TEXTURE_MIN_FILTER,$[S.minFilter]),S.compareFunction&&(t.texParameteri(R,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(R,t.TEXTURE_COMPARE_FUNC,j[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Tn||S.minFilter!==da&&S.minFilter!==Er||S.type===mi&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const H=e.get("EXT_texture_filter_anisotropic");t.texParameterf(R,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function de(R,S){let H=!1;R.__webglInit===void 0&&(R.__webglInit=!0,S.addEventListener("dispose",L));const ee=S.source;let ne=d.get(ee);ne===void 0&&(ne={},d.set(ee,ne));const J=O(S);if(J!==R.__cacheKey){ne[J]===void 0&&(ne[J]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,H=!0),ne[J].usedTimes++;const Ee=ne[R.__cacheKey];Ee!==void 0&&(ne[R.__cacheKey].usedTimes--,Ee.usedTimes===0&&C(S)),R.__cacheKey=J,R.__webglTexture=ne[J].texture}return H}function Se(R,S,H){let ee=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(ee=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&(ee=t.TEXTURE_3D);const ne=de(R,S),J=S.source;n.bindTexture(ee,R.__webglTexture,t.TEXTURE0+H);const Ee=i.get(J);if(J.version!==Ee.__version||ne===!0){n.activeTexture(t.TEXTURE0+H);const ce=je.getPrimaries(je.workingColorSpace),me=S.colorSpace===zi?null:je.getPrimaries(S.colorSpace),Ue=S.colorSpace===zi||ce===me?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ue);let re=x(S.image,!1,r.maxTextureSize);re=Le(S,re);const pe=s.convert(S.format,S.colorSpace),ke=s.convert(S.type);let Re=_(S.internalFormat,pe,ke,S.colorSpace,S.isVideoTexture);ie(ee,S);let ge;const De=S.mipmaps,Oe=S.isVideoTexture!==!0,ot=Ee.__version===void 0||ne===!0,I=J.dataReady,se=M(S,re);if(S.isDepthTexture)Re=g(S.format===Us,S.type),ot&&(Oe?n.texStorage2D(t.TEXTURE_2D,1,Re,re.width,re.height):n.texImage2D(t.TEXTURE_2D,0,Re,re.width,re.height,0,pe,ke,null));else if(S.isDataTexture)if(De.length>0){Oe&&ot&&n.texStorage2D(t.TEXTURE_2D,se,Re,De[0].width,De[0].height);for(let q=0,K=De.length;q<K;q++)ge=De[q],Oe?I&&n.texSubImage2D(t.TEXTURE_2D,q,0,0,ge.width,ge.height,pe,ke,ge.data):n.texImage2D(t.TEXTURE_2D,q,Re,ge.width,ge.height,0,pe,ke,ge.data);S.generateMipmaps=!1}else Oe?(ot&&n.texStorage2D(t.TEXTURE_2D,se,Re,re.width,re.height),I&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,re.width,re.height,pe,ke,re.data)):n.texImage2D(t.TEXTURE_2D,0,Re,re.width,re.height,0,pe,ke,re.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Oe&&ot&&n.texStorage3D(t.TEXTURE_2D_ARRAY,se,Re,De[0].width,De[0].height,re.depth);for(let q=0,K=De.length;q<K;q++)if(ge=De[q],S.format!==Bn)if(pe!==null)if(Oe){if(I)if(S.layerUpdates.size>0){const ae=sm(ge.width,ge.height,S.format,S.type);for(const we of S.layerUpdates){const Ve=ge.data.subarray(we*ae/ge.data.BYTES_PER_ELEMENT,(we+1)*ae/ge.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,q,0,0,we,ge.width,ge.height,1,pe,Ve,0,0)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,q,0,0,0,ge.width,ge.height,re.depth,pe,ge.data,0,0)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,q,Re,ge.width,ge.height,re.depth,0,ge.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?I&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,q,0,0,0,ge.width,ge.height,re.depth,pe,ke,ge.data):n.texImage3D(t.TEXTURE_2D_ARRAY,q,Re,ge.width,ge.height,re.depth,0,pe,ke,ge.data)}else{Oe&&ot&&n.texStorage2D(t.TEXTURE_2D,se,Re,De[0].width,De[0].height);for(let q=0,K=De.length;q<K;q++)ge=De[q],S.format!==Bn?pe!==null?Oe?I&&n.compressedTexSubImage2D(t.TEXTURE_2D,q,0,0,ge.width,ge.height,pe,ge.data):n.compressedTexImage2D(t.TEXTURE_2D,q,Re,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?I&&n.texSubImage2D(t.TEXTURE_2D,q,0,0,ge.width,ge.height,pe,ke,ge.data):n.texImage2D(t.TEXTURE_2D,q,Re,ge.width,ge.height,0,pe,ke,ge.data)}else if(S.isDataArrayTexture)if(Oe){if(ot&&n.texStorage3D(t.TEXTURE_2D_ARRAY,se,Re,re.width,re.height,re.depth),I)if(S.layerUpdates.size>0){const q=sm(re.width,re.height,S.format,S.type);for(const K of S.layerUpdates){const ae=re.data.subarray(K*q/re.data.BYTES_PER_ELEMENT,(K+1)*q/re.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,K,re.width,re.height,1,pe,ke,ae)}S.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,pe,ke,re.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Re,re.width,re.height,re.depth,0,pe,ke,re.data);else if(S.isData3DTexture)Oe?(ot&&n.texStorage3D(t.TEXTURE_3D,se,Re,re.width,re.height,re.depth),I&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,pe,ke,re.data)):n.texImage3D(t.TEXTURE_3D,0,Re,re.width,re.height,re.depth,0,pe,ke,re.data);else if(S.isFramebufferTexture){if(ot)if(Oe)n.texStorage2D(t.TEXTURE_2D,se,Re,re.width,re.height);else{let q=re.width,K=re.height;for(let ae=0;ae<se;ae++)n.texImage2D(t.TEXTURE_2D,ae,Re,q,K,0,pe,ke,null),q>>=1,K>>=1}}else if(De.length>0){if(Oe&&ot){const q=Ie(De[0]);n.texStorage2D(t.TEXTURE_2D,se,Re,q.width,q.height)}for(let q=0,K=De.length;q<K;q++)ge=De[q],Oe?I&&n.texSubImage2D(t.TEXTURE_2D,q,0,0,pe,ke,ge):n.texImage2D(t.TEXTURE_2D,q,Re,pe,ke,ge);S.generateMipmaps=!1}else if(Oe){if(ot){const q=Ie(re);n.texStorage2D(t.TEXTURE_2D,se,Re,q.width,q.height)}I&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,pe,ke,re)}else n.texImage2D(t.TEXTURE_2D,0,Re,pe,ke,re);m(S)&&c(ee),Ee.__version=J.version,S.onUpdate&&S.onUpdate(S)}R.__version=S.version}function V(R,S,H){if(S.image.length!==6)return;const ee=de(R,S),ne=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,R.__webglTexture,t.TEXTURE0+H);const J=i.get(ne);if(ne.version!==J.__version||ee===!0){n.activeTexture(t.TEXTURE0+H);const Ee=je.getPrimaries(je.workingColorSpace),ce=S.colorSpace===zi?null:je.getPrimaries(S.colorSpace),me=S.colorSpace===zi||Ee===ce?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,me);const Ue=S.isCompressedTexture||S.image[0].isCompressedTexture,re=S.image[0]&&S.image[0].isDataTexture,pe=[];for(let K=0;K<6;K++)!Ue&&!re?pe[K]=x(S.image[K],!0,r.maxCubemapSize):pe[K]=re?S.image[K].image:S.image[K],pe[K]=Le(S,pe[K]);const ke=pe[0],Re=s.convert(S.format,S.colorSpace),ge=s.convert(S.type),De=_(S.internalFormat,Re,ge,S.colorSpace),Oe=S.isVideoTexture!==!0,ot=J.__version===void 0||ee===!0,I=ne.dataReady;let se=M(S,ke);ie(t.TEXTURE_CUBE_MAP,S);let q;if(Ue){Oe&&ot&&n.texStorage2D(t.TEXTURE_CUBE_MAP,se,De,ke.width,ke.height);for(let K=0;K<6;K++){q=pe[K].mipmaps;for(let ae=0;ae<q.length;ae++){const we=q[ae];S.format!==Bn?Re!==null?Oe?I&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ae,0,0,we.width,we.height,Re,we.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ae,De,we.width,we.height,0,we.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Oe?I&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ae,0,0,we.width,we.height,Re,ge,we.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ae,De,we.width,we.height,0,Re,ge,we.data)}}}else{if(q=S.mipmaps,Oe&&ot){q.length>0&&se++;const K=Ie(pe[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,se,De,K.width,K.height)}for(let K=0;K<6;K++)if(re){Oe?I&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,pe[K].width,pe[K].height,Re,ge,pe[K].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,De,pe[K].width,pe[K].height,0,Re,ge,pe[K].data);for(let ae=0;ae<q.length;ae++){const Ve=q[ae].image[K].image;Oe?I&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ae+1,0,0,Ve.width,Ve.height,Re,ge,Ve.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ae+1,De,Ve.width,Ve.height,0,Re,ge,Ve.data)}}else{Oe?I&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Re,ge,pe[K]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,De,Re,ge,pe[K]);for(let ae=0;ae<q.length;ae++){const we=q[ae];Oe?I&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ae+1,0,0,Re,ge,we.image[K]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+K,ae+1,De,Re,ge,we.image[K])}}}m(S)&&c(t.TEXTURE_CUBE_MAP),J.__version=ne.version,S.onUpdate&&S.onUpdate(S)}R.__version=S.version}function Q(R,S,H,ee,ne,J){const Ee=s.convert(H.format,H.colorSpace),ce=s.convert(H.type),me=_(H.internalFormat,Ee,ce,H.colorSpace);if(!i.get(S).__hasExternalTextures){const re=Math.max(1,S.width>>J),pe=Math.max(1,S.height>>J);ne===t.TEXTURE_3D||ne===t.TEXTURE_2D_ARRAY?n.texImage3D(ne,J,me,re,pe,S.depth,0,Ee,ce,null):n.texImage2D(ne,J,me,re,pe,0,Ee,ce,null)}n.bindFramebuffer(t.FRAMEBUFFER,R),Me(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ee,ne,i.get(H).__webglTexture,0,Je(S)):(ne===t.TEXTURE_2D||ne>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,ee,ne,i.get(H).__webglTexture,J),n.bindFramebuffer(t.FRAMEBUFFER,null)}function ue(R,S,H){if(t.bindRenderbuffer(t.RENDERBUFFER,R),S.depthBuffer){const ee=S.depthTexture,ne=ee&&ee.isDepthTexture?ee.type:null,J=g(S.stencilBuffer,ne),Ee=S.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ce=Je(S);Me(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ce,J,S.width,S.height):H?t.renderbufferStorageMultisample(t.RENDERBUFFER,ce,J,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,J,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Ee,t.RENDERBUFFER,R)}else{const ee=S.textures;for(let ne=0;ne<ee.length;ne++){const J=ee[ne],Ee=s.convert(J.format,J.colorSpace),ce=s.convert(J.type),me=_(J.internalFormat,Ee,ce,J.colorSpace),Ue=Je(S);H&&Me(S)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ue,me,S.width,S.height):Me(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ue,me,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,me,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Z(R,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,R),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(S.depthTexture).__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),X(S.depthTexture,0);const ee=i.get(S.depthTexture).__webglTexture,ne=Je(S);if(S.depthTexture.format===Ss)Me(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ee,0,ne):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ee,0);else if(S.depthTexture.format===Us)Me(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ee,0,ne):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ee,0);else throw new Error("Unknown depthTexture format")}function xe(R){const S=i.get(R),H=R.isWebGLCubeRenderTarget===!0;if(R.depthTexture&&!S.__autoAllocateDepthBuffer){if(H)throw new Error("target.depthTexture not supported in Cube render targets");Z(S.__webglFramebuffer,R)}else if(H){S.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[ee]),S.__webglDepthbuffer[ee]=t.createRenderbuffer(),ue(S.__webglDepthbuffer[ee],R,!1)}else n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer=t.createRenderbuffer(),ue(S.__webglDepthbuffer,R,!1);n.bindFramebuffer(t.FRAMEBUFFER,null)}function Pe(R,S,H){const ee=i.get(R);S!==void 0&&Q(ee.__webglFramebuffer,R,R.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),H!==void 0&&xe(R)}function be(R){const S=R.texture,H=i.get(R),ee=i.get(S);R.addEventListener("dispose",A);const ne=R.textures,J=R.isWebGLCubeRenderTarget===!0,Ee=ne.length>1;if(Ee||(ee.__webglTexture===void 0&&(ee.__webglTexture=t.createTexture()),ee.__version=S.version,o.memory.textures++),J){H.__webglFramebuffer=[];for(let ce=0;ce<6;ce++)if(S.mipmaps&&S.mipmaps.length>0){H.__webglFramebuffer[ce]=[];for(let me=0;me<S.mipmaps.length;me++)H.__webglFramebuffer[ce][me]=t.createFramebuffer()}else H.__webglFramebuffer[ce]=t.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){H.__webglFramebuffer=[];for(let ce=0;ce<S.mipmaps.length;ce++)H.__webglFramebuffer[ce]=t.createFramebuffer()}else H.__webglFramebuffer=t.createFramebuffer();if(Ee)for(let ce=0,me=ne.length;ce<me;ce++){const Ue=i.get(ne[ce]);Ue.__webglTexture===void 0&&(Ue.__webglTexture=t.createTexture(),o.memory.textures++)}if(R.samples>0&&Me(R)===!1){H.__webglMultisampledFramebuffer=t.createFramebuffer(),H.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let ce=0;ce<ne.length;ce++){const me=ne[ce];H.__webglColorRenderbuffer[ce]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,H.__webglColorRenderbuffer[ce]);const Ue=s.convert(me.format,me.colorSpace),re=s.convert(me.type),pe=_(me.internalFormat,Ue,re,me.colorSpace,R.isXRRenderTarget===!0),ke=Je(R);t.renderbufferStorageMultisample(t.RENDERBUFFER,ke,pe,R.width,R.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ce,t.RENDERBUFFER,H.__webglColorRenderbuffer[ce])}t.bindRenderbuffer(t.RENDERBUFFER,null),R.depthBuffer&&(H.__webglDepthRenderbuffer=t.createRenderbuffer(),ue(H.__webglDepthRenderbuffer,R,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(J){n.bindTexture(t.TEXTURE_CUBE_MAP,ee.__webglTexture),ie(t.TEXTURE_CUBE_MAP,S);for(let ce=0;ce<6;ce++)if(S.mipmaps&&S.mipmaps.length>0)for(let me=0;me<S.mipmaps.length;me++)Q(H.__webglFramebuffer[ce][me],R,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ce,me);else Q(H.__webglFramebuffer[ce],R,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0);m(S)&&c(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Ee){for(let ce=0,me=ne.length;ce<me;ce++){const Ue=ne[ce],re=i.get(Ue);n.bindTexture(t.TEXTURE_2D,re.__webglTexture),ie(t.TEXTURE_2D,Ue),Q(H.__webglFramebuffer,R,Ue,t.COLOR_ATTACHMENT0+ce,t.TEXTURE_2D,0),m(Ue)&&c(t.TEXTURE_2D)}n.unbindTexture()}else{let ce=t.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ce=R.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ce,ee.__webglTexture),ie(ce,S),S.mipmaps&&S.mipmaps.length>0)for(let me=0;me<S.mipmaps.length;me++)Q(H.__webglFramebuffer[me],R,S,t.COLOR_ATTACHMENT0,ce,me);else Q(H.__webglFramebuffer,R,S,t.COLOR_ATTACHMENT0,ce,0);m(S)&&c(ce),n.unbindTexture()}R.depthBuffer&&xe(R)}function tt(R){const S=R.textures;for(let H=0,ee=S.length;H<ee;H++){const ne=S[H];if(m(ne)){const J=R.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:t.TEXTURE_2D,Ee=i.get(ne).__webglTexture;n.bindTexture(J,Ee),c(J),n.unbindTexture()}}}const b=[],gt=[];function Ke(R){if(R.samples>0){if(Me(R)===!1){const S=R.textures,H=R.width,ee=R.height;let ne=t.COLOR_BUFFER_BIT;const J=R.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Ee=i.get(R),ce=S.length>1;if(ce)for(let me=0;me<S.length;me++)n.bindFramebuffer(t.FRAMEBUFFER,Ee.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Ee.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Ee.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ee.__webglFramebuffer);for(let me=0;me<S.length;me++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(ne|=t.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(ne|=t.STENCIL_BUFFER_BIT)),ce){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Ee.__webglColorRenderbuffer[me]);const Ue=i.get(S[me]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Ue,0)}t.blitFramebuffer(0,0,H,ee,0,0,H,ee,ne,t.NEAREST),l===!0&&(b.length=0,gt.length=0,b.push(t.COLOR_ATTACHMENT0+me),R.depthBuffer&&R.resolveDepthBuffer===!1&&(b.push(J),gt.push(J),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,gt)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,b))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ce)for(let me=0;me<S.length;me++){n.bindFramebuffer(t.FRAMEBUFFER,Ee.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.RENDERBUFFER,Ee.__webglColorRenderbuffer[me]);const Ue=i.get(S[me]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Ee.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.TEXTURE_2D,Ue,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ee.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){const S=R.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[S])}}}function Je(R){return Math.min(r.maxSamples,R.samples)}function Me(R){const S=i.get(R);return R.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function _t(R){const S=o.render.frame;f.get(R)!==S&&(f.set(R,S),R.update())}function Le(R,S){const H=R.colorSpace,ee=R.format,ne=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||H!==rr&&H!==zi&&(je.getTransfer(H)===it?(ee!==Bn||ne!==Ei)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",H)),S}function Ie(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(u.width=R.naturalWidth||R.width,u.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(u.width=R.displayWidth,u.height=R.displayHeight):(u.width=R.width,u.height=R.height),u}this.allocateTextureUnit=k,this.resetTextureUnits=P,this.setTexture2D=X,this.setTexture2DArray=W,this.setTexture3D=G,this.setTextureCube=Y,this.rebindTextures=Pe,this.setupRenderTarget=be,this.updateRenderTargetMipmap=tt,this.updateMultisampleRenderTarget=Ke,this.setupDepthRenderbuffer=xe,this.setupFrameBufferTexture=Q,this.useMultisampledRTT=Me}function JT(t,e){function n(i,r=zi){let s;const o=je.getTransfer(r);if(i===Ei)return t.UNSIGNED_BYTE;if(i===Ud)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Nd)return t.UNSIGNED_SHORT_5_5_5_1;if(i===O_)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===N_)return t.BYTE;if(i===F_)return t.SHORT;if(i===Fo)return t.UNSIGNED_SHORT;if(i===Id)return t.INT;if(i===Dr)return t.UNSIGNED_INT;if(i===mi)return t.FLOAT;if(i===Go)return t.HALF_FLOAT;if(i===z_)return t.ALPHA;if(i===B_)return t.RGB;if(i===Bn)return t.RGBA;if(i===k_)return t.LUMINANCE;if(i===H_)return t.LUMINANCE_ALPHA;if(i===Ss)return t.DEPTH_COMPONENT;if(i===Us)return t.DEPTH_STENCIL;if(i===V_)return t.RED;if(i===Fd)return t.RED_INTEGER;if(i===G_)return t.RG;if(i===Od)return t.RG_INTEGER;if(i===zd)return t.RGBA_INTEGER;if(i===Ja||i===el||i===tl||i===nl)if(o===it)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ja)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===el)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===tl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===nl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ja)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===el)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===tl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===nl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===lf||i===uf||i===cf||i===ff)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===lf)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===uf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===cf)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===ff)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===df||i===hf||i===pf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===df||i===hf)return o===it?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===pf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===mf||i===gf||i===_f||i===vf||i===xf||i===yf||i===Sf||i===Mf||i===Ef||i===Tf||i===wf||i===Af||i===Cf||i===Rf)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===mf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===gf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===_f)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===vf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===xf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===yf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Sf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Mf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Ef)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Tf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===wf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Af)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Cf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Rf)return o===it?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===il||i===Pf||i===bf)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===il)return o===it?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Pf)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===bf)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===W_||i===Lf||i===Df||i===If)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===il)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Lf)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Df)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===If)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Is?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}class ew extends Mn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ua extends an{constructor(){super(),this.isGroup=!0,this.type="Group"}}const tw={type:"move"};class rc{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ua,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ua,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new F,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new F),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ua,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new F,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new F),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,u=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(u&&e.hand){o=!0;for(const x of e.hand.values()){const m=n.getJointPose(x,i),c=this._getHandJoint(u,x);m!==null&&(c.matrix.fromArray(m.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,c.jointRadius=m.radius),c.visible=m!==null}const f=u.joints["index-finger-tip"],h=u.joints["thumb-tip"],d=f.position.distanceTo(h.position),p=.02,v=.005;u.inputState.pinching&&d>p+v?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&d<=p-v&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(tw)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),u!==null&&(u.visible=o!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new Ua;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}const nw=`
void main() {
